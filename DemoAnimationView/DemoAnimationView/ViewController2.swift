...
class ViewController2: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        let urlString = "https://media.giphy.com/media/fAV73wP5H7xN6/giphy.gif"
//        let url = URL(string: urlString)
//
//        guard let data = try? Data(contentsOf: url!) else { fatalError("error url") }
//        loadGif.image = UIImage.animatedImage(data: data)
    ...
    static func animatedImage(data: Data) -> UIImage? {
        ...
        for i: Int in 0 ..< CGImageSourceGetCount(source) {
            ...
            if let delay = gif["UnclampedDelayTime"] as? TimeInterval, delay > 0.0 {
                ...
                frames.append((image, 0.01)) // WebKit default
            }
        }
